...
{
    public static final String HOST = "212.100.239.152";
    public static final int PORT = 5222;
    public static final String SERVICE = "212.100.239.152";
    ...
    public void login(String login, String password) throws IOException, SmackException, XMPPException
    {
        ...
        if (mConnection != null)
        {
            ...
            Message message = new Message("haider@212.100.239.152", Message.Type.chat);
